     ...
     <div className="px-1 lg:px-[23%] ">
       <Heading tittle="Fostering" dynamic="Achievement Tales" text="We're committed to nurturing success, helping businesses from various
          ...
          <div className="w-full md:w-1/2  pb-8 md:pb-0 md:border-r"> 
             ...
             <Image className=" w-8 lg:w-10" src={'/journey.svg'}  alt="" width={45} height={25}/>
             <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl  text-white font-bold">From Frustration to</h1>
             <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl useclass font-bold">Success</h1>
             </div>
             <div className="flex flex-col text-left px-4 md:px-[9%]">
             <p className="pt-3 text-stone-400 mt-2 text-sm md:text-base lg:text-lg">In 2015, a young boy, frustrated by his father's automobile business challenges, discovered a market gap in digital transitions for brick-and-mortar businesses. His successful digital marketing project for his father’s business inspired him to co-found ConceptRecall with a tech-savvy partner. Starting as a small digital agency, it has grown to over 100 employees, dedicated to digitizing businesses.
            <br/>
            <br/>
          ...
          <div className="w-full md:w-1/2 px-4 md:px-[4%]">
            ...
            <p className="py-4 text-stone-400 mt-2 text-sm md:text-base lg:text-lg">Throughout our history, we've driven many companies towards prosperity, fostering strong relationships with a teamwork-driven mindset.
            <br/>
            <br/>
            ...
            <div className="">
               <p className="py-3 text-stone-400 mt-2 text-sm md:text-base lg:text-lg">We've guided over 250 businesses towards achieving their goals through our creative strategies.</p>
            </div>
            </div>
            <hr className="border-gray-400 " />
            <div className="flex flex-col md:flex-row gap-2 md:justify-center md:items-center py-6">
