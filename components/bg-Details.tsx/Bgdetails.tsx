...
const BgDetails = () =>{
    return(
<section
        className="flex justify-center items-center flex-col h-[calc(100vh-83px)] max-sm:pb-11 max-lg:h-[calc(100vh-66px)] max-sm:h-[max-content] overflow-hidden md:shrink-0"
