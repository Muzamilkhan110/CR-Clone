              ...
              <ul className="space-y-4">
                ...
                <li>
                  ...
                  <Link
                    ...
                    className="text-white hover:useclass transition duration-200"
                  >
                    B-219, Block 10 Gulshan-e-Iqbal, Karachi, Karachi City,
                    Sindh 75300
                  </Link>
                </li>
              </ul>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 flex items-center border rounded-md bg-transparent focus:outline-none focus:ring-0">
              <input
                ...
                className="flex-1 p-4 bg-transparent focus:outline-none text-neutral-600 rounded-l-md" // Added rounded-l-md
              />
              {/* <Button
                text="Submit"
                className="sm:m-0 px-4 py-3 bg-blue-600 text-white rounded-r-md" 
              /> */}
            </div>
          </div>
        </div>
